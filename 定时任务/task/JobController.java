...
public class JobController {
    ...
    public String refresh(@PathVariable Integer id) throws SchedulerException {
        String result;
        JobName entity = jobService.getJobEntityById(id);
    ...
    private void reStartAllJobs() throws SchedulerException {
        ...
        for (JobName job : jobService.loadJobs()) {
            ...
            else log.info("Job jump name : {} , Because {} status is {}", job.getName(), job.getName(), job.getStatus());
        }
    }
}
